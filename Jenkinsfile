...
def runStage(pname, myBuildFrom, stage, allStages, paramShortCircuit, paramBreakBefore, mySourceBranch, myLuks, mySeparateBoot, myRelease, timeout) {
	def thisStageIdx = allStages.findIndexOf{ it == stage }
