...
5. Development packages necessary to build ZFS will be installed.
6. My git repositories for ZFS will be cloned, built, and installed in a DKMS configuration.
